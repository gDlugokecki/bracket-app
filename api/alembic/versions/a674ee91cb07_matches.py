...
Revision ID: a674ee91cb07
Revises: a4c81bfadd9f
Create Date: 2026-01-06 19:08:17.065125
...
revision: str = 'a674ee91cb07'
down_revision: Union[str, Sequence[str], None] = 'a4c81bfadd9f'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELED', name='matchstatus'), nullable=False),
    sa.Column('scheduled_time', sa.DateTime(), nullable=False),
    sa.Column('court_number', sa.String(), nullable=True),
